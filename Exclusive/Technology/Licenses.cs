...
namespace MiMFa.Exclusive.Technology
{
    ...
    {
        private static List<string> AsposeList = new List<string>(){
            "Aspose.3D.dll",
            "Aspose.BarCode.dll",
            "Aspose.BarCode.Compact.dll",
        ...
        {
            MethodInfo miLicensed1 = typeof(Licenses).GetMethod("InvokeMe1", BindingFlags.NonPublic | BindingFlags.Static);
            MethodInfo miLicensed2 = typeof(Licenses).GetMethod("InvokeMe2", BindingFlags.NonPublic | BindingFlags.Static);
            ...
            try
            {
                ...
                Stream stream = new MemoryStream(System.Convert.FromBase64String(LData));
        ...
        private static XmlElement InvokeMe2(XmlElement element, string name)
        {
            if (element.LocalName == "License")
            {
                ...
                element.InnerXml = new UTF8Encoding().GetString(System.Convert.FromBase64String(License64));
            }
            ...
            if (element.LocalName == "BlackList")
            {
                ...
                element.InnerXml = new UTF8Encoding().GetString(System.Convert.FromBase64String(BlackList64));
            }
